		...
		var i = 0,
			...
			n = function() {
				function c(a, d) {
					...
					}), this.e = Boolean(a.getAttribute("value"))
				}
				return d(c, [{
					key: "_init",
					value: function() {
					...
					value: function() {
						...
						if (window.intlTelInputUtils && a) {
							...
							c = this._7(c), "function" == typeof this.d.customPlaceholder && (c = this.d.customPlaceholder(c, this.s)), this.a.setAttribute("value", c)
						}
					}
				}, {
					key: "_1",
