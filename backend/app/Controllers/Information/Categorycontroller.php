...
class Categorycontroller extends BaseController
{
	public function index() {
        ...
        else
        {
            ...
            $data = [
                'type'     => $m_type->getkodetype(),
            ];
			
            return view('menuinformation/view_categorytype', $data);
        }
    }
    ...
    public function getdata() {
        ...
        else
        {
            if ($this->request->isAJAX())
            {
                ...
                $gen  = "KTPM" . str_pad($kode, 3, 0, STR_PAD_LEFT);
        ...
        else
        {
			...
			else
			{
                $data = [
					...
					'kode_jenis_pengumuman' => $this->request->getVar('infocategory_jenispengumuman'),
                ];
            ...
            if ($this->request->isAJAX())
            {
                ...
                else
                {
                    $data = [
						...
						'kode_jenis_pengumuman' => $this->request->getVar('infocategory_jenispengumumanubah'),
                    ];
