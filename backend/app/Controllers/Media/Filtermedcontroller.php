        ...
        else
        {
			...
			else
			{
                $data = [
					...
					'jenis_media' => $this->request->getVar('mediafilter_jenis'),
                ];
            ...
            if ($this->request->isAJAX())
            {
                ...
                else
                {
                    $data = [
						...
						'jenis_media' => $this->request->getVar('mediafilter_jenisubah'),
                    ];
    ...
    public function hapusdata() {
        ...
        else
        {
            if ($this->request->isAJAX()) {
                ...
                $msg = [
                    'success' => [
                        'data' => 'Berhasil menghapus data media filter dengan kode ' . $kode,
                        'link' => '/admmediafilter'
                     ]
                ];
            }
