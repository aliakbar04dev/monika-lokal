...
use App\Models\Ultimate\TrailingclosedModel;
use Config\Services;

class Trailingclosedcontroller extends BaseController
{
	public function index() {
        ...
        {
            return view('menuultimate/view_ultimatetrailclosed');
        }
    }
    ...
    public function ajax_list() {
        ...
        else
        {
            if ($this->request->isAJAX())
            {
                ...
                $m_trailclosed = new TrailingclosedModel($request);

                if($request->getMethod(true)=='POST'){
                    $lists = $m_trailclosed->get_datatables();
                        $data = [];
                        ...
                        foreach ($lists as $list) {
                                ...
                                $tomboledit = "<button type=\"button\" class=\"btn btn-warning btn-sm btneditinfocategory\"
                                                onclick=\"editultimatetrailclosed('" .$list->kode_trailingclose. "')\">
                                                <i class=\"fa fa-edit\"></i></button>";

                                $tombolhapus = "<button type=\"button\" class=\"btn btn-danger btn-sm\" 
                                                onclick=\"deleteultimatetrailclosed('" .$list->kode_trailingclose. "')\"> 
                        ...
                        $output = [
                            ...
                            "recordsTotal" => $m_trailclosed->count_all(),
                            "recordsFiltered" => $m_trailclosed->count_filtered(),
                            "data" => $data
                        ];
    ...
    public function simpandata() {
        ...
        else
        {
            if ($this->request->isAJAX())
            {
                $validationCheck = $this->validate([
                    'ultimateclosepos_kode' => [
                        ...
                        'rules' => [
                            'required',
                            'is_unique[t_trailingclosed.kode_trailingclose]',
                        ],
                        'errors' => [
			...
			{              
                $data = [
                    'kode_trailingclose' => $this->request->getVar('ultimateclosepos_kode'),
                    ...
                    'is_active' => $this->request->getVar('ultimateclosepos_isactive'),
                ];

                $request = Services::request();
                $m_trailclosed = new TrailingclosedModel($request);

                $m_trailclosed->insert($data);
    ...
    public function pilihdata() {
        ...
        else
        {
            if ($this->request->isAJAX()) {
                ...
                $item = $m_trailclosed->find($kode);
    
                $data = [
                    'success' => [
                        'kode' => $item['kode_trailingclose'],
                        'stock' => $item['stock'],
            ...
            if ($this->request->isAJAX())
            {
                ...
                else
                {
                    $data = [
                        ...
                        'is_active' => $this->request->getVar('ultimateclosepos_isactiveubah'),
                    ];
                    ...
                    $m_trailclosed->update($kode, $data);
