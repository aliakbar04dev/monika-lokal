...
class NewsModel extends Model {
    ...
    protected $allowedFields = ['kode_pengumuman', 'kode_jenis_pengumuman', 'kode_kategori_pengumuman', 
                                'tgl_pengumuman', 'judul', 'isi_pengumuman', 'status', 'gambar', 'cover', 'status_notif', 'is_active'];
    protected $column_order = array('', 'tgl_pengumuman', 'kode_jenis_pengumuman', 'status', 'kode_kategori_pengumuman', 'judul', '');
    protected $column_search = array('tgl_pengumuman','kode_kategori_pengumuman', 'status', 'judul');
