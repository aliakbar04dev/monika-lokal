...
class AdministratorModel extends Model {
    ...
    function count_filtered(){
        $tbl_storagefilter = $this->db->table($this->table)->where('kode_user_level', 'MULV006');
        return $tbl_storagefilter->countAllResults();
    }

    public function count_all(){
        $tbl_storage = $this->db->table($this->table)->where('kode_user_level', 'MULV006');
