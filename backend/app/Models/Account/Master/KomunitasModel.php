...
class KomunitasModel extends Model {
    ...
    protected $allowedFields = ['client_id', 'user_id', 'kode_account', 'client_id_date', 'mtbi_id', 'mtbi_date',
    ...
    function cekData($clientid)
    {
        return $this->dt->where('client_id', $clientid)->get()->getRowArray();
    }
