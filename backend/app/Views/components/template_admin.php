...
<head>
  ...
  <title>Administrator | Monika PanenSaham</title>
  ...
  <link rel="icon" href="https://monika.panensaham.com/public/assets/img/favicon.png">
  ...
  <link rel="stylesheet" href="<?= base_url() ?>/public/assets/vendor/quill/dist/quill.core.css">
...
<body>
  ...
  <!-- Custom JS -->
  <script src="<?= base_url() ?>/public/assets/js/billing/invoice.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/package/discount.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/package/price.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/account/userlevel.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/account/member.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/account/administrator.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/account/user.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/account/master/anggota.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/account/master/komunitas.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/account/master/referal.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/features/jenis_tsakti.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/features/t_sakti.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/features/poin.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/features/referal.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/features/ultimate.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/ultimate/trailing.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/trailingclosed.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/trailingact.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/daily.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/dailyact.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/dailychart.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/dailyclosed.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/wtcaction.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/wtcdata.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/openpos.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/closepos.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/copyact.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/ultimate/factsheet.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/information/category.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/information/type.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/information/news.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/information/tutorial.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/information/faq.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/information/bursaemiten.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/media/filtermed.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/media/filtersubmed.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/media/imagemed.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/media/videomed.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/media/videonewmed.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/feedback/question.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/feedback/subscriber.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/setting/banner.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/setting/benefit.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/setting/custom.js"></script>

  <script src="<?= base_url() ?>/public/assets/js/career/categorycar.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/career/department.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/career/location.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/career/vacancy.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/career/applied.js"></script>
  <script src="<?= base_url() ?>/public/assets/js/career/testimonicar.js"></script>
