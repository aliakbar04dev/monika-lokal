...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Faq</h3>
              <p class="text-sm mb-0">
                Faq berisi pertanyaan umum yang sering diajukan oleh user baru
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahinfofaq">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-infofaq">
    ...
    <?= $this->include('menuinformation/add_infofaq'); ?>
	<?= $this->include('menuinformation/edit_infofaq'); ?>
<?= $this->endSection(); ?>