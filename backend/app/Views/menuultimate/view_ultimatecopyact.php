...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Article Copy Trade</h3>
              <p class="text-sm mb-0">
                Berisi article yang akan ditampilkan pada table copy trade difitur ultimate
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahultimatecopyact"
                      onClick="generatekodeultimatecopyact()">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-ultimatecopyact">
    ...
    <?= $this->include('menuultimate/add_ultimatecopyact'); ?>
    <?= $this->include('menuultimate/edit_ultimatecopyact'); ?>
<?= $this->endSection(); ?>