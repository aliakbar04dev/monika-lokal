 <!-- Modal Tambah Info -->
 <div class="modal fade" id="modalubahultimateclosepos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ubah Data Copy Trades | Close Position</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <!-- Handle Form -->
        <?= form_open_multipart('ultimate/closeposcontroller/perbaruidata',
           ['class' => 'formModalubahultimateclosepos']); ?>
        <?= csrf_field(); ?>
        ...
        <div class="modal-footer" style="margin-top: -40px;">
            ...
            <button type="submit" class="btn btn-warning btnmodalubahultimateclosepos">Update</button>
        </div>
