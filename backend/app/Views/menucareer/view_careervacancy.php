...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Karir</h3>
              <p class="text-sm mb-0">
                Berisi karir yang tersedia
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahcareervacancy" onClick="generatekodecareervacancy()">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-careervacancy">
    ...
    <?= $this->include('menucareer/add_careervacancy'); ?>
    <?= $this->include('menucareer/edit_careervacancy'); ?>
