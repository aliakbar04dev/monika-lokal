...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Diskon Paket</h3>
              <p class="text-sm mb-0">
                Data ini berisi informasi diskon yang tersedia berdasarkan level pada member
              </p>
            ...
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-packagedisc">
    ...
    <?= $this->include('menupackage/add_packagedisc'); ?>
	<?= $this->include('menupackage/edit_packagedisc'); ?>
<?= $this->endSection(); ?>