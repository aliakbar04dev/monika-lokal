...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Master Anggota</h3>
              <p class="text-sm mb-0">
                Berisi data member anggota koperasi yang terdaftar pada sistem panen saham
              </p>

                <button type="button" class="btn btn-primary btn-sm mt-3" 
                        data-toggle="modal" data-target="#modaltambahmasteranggota">
            ...
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-masteranggota">
    ...
    <?= $this->include('menuaccount/submenumaster/add_masteranggota'); ?>
<?= $this->endSection(); ?>