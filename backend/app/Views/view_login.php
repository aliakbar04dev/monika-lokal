        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
             <img src="https://monika.panensaham.com/public/assets/img/logo monika new.png" width="100%">
              <div class="text-center text-muted mb-4" style="margin-top: 5px;">
                <h4>Login Admin</h4>
              </div>

              <!-- Handle FORM -->
               <?= form_open('Login/authLogin', ['class' => 'formLogin']); ?>
                <?= csrf_field(); ?>
                <div class="form-group mb-3">
                  <div class="input-group">
                    ...
                    <input class="form-control" placeholder="Alamat Email" type="text" name="emailaddr" id="emailaddr">
                    <!-- Error Validation -->
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary my-4 btnLogin">Sign in</button>
                </div>
                <?= form_close(); ?>
              <!-- Handle FORM -->
            </div>
