...
<?= $this->section('content') ?>
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahmediavideo" 
                      onClick="generatekodemediavideo()">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-mediavideo">
    ...
    <?= $this->include('menumedia/add_mediavideo'); ?>
    <?= $this->include('menumedia/edit_mediavideo'); ?>
<?= $this->endSection(); ?>