 ...
 <div class="modal fade" id="modalubahmediafilter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Ubah Data Kategori Media</h5>
        ...
        <div class="modal-body">
                <div class="form-group">
                  <label for="kode-infocategory-input" class="form-control-label">Kode Kategori</label>
                ...
                <div class="form-group">
                  <label for="nama-infocategory-input" class="form-control-label">Nama Kategori</label>
				...
				<div class="form-group">
                  <label for="kode-infocategory-input" class="form-control-label">Jenis Media</label>
                  <select class="form-control" id="mediafilter_jenisubah" name="mediafilter_jenisubah">
                    <option value="Video">
                        Video
                    </option>
                    <option value="Gambar">
