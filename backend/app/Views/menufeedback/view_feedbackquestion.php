...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Question</h3>
              <p class="text-sm mb-0">
                Berisi pertanyaan yang diajukan oleh pengguna
              </p>
              ...
              <!-- </button> -->
              <form action="feedback/questioncontroller/proses" method="POST" >
                  <button type="submit" class="btn btn-primary btn-sm mt-3">Export Excel</button>
              </form>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-feedbackquestion">
    ...
    <?= $this->include('menufeedback/edit_feedbackquestion'); ?>
<?= $this->endSection(); ?>