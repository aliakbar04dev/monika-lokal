...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Subscriber</h3>
              <p class="text-sm mb-0">
                Berisi data email pengguna yang berlangganan panen saham
              </p>
              ...
              <form action="feedback/subscribercontroller/proses" method="POST" >
                  <button type="submit" class="btn btn-primary btn-sm mt-3">Export Excel</button>
              </form>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-feedbacksubscribe">
    ...
    <?= $this->include('menuaccount/add_accountmember'); ?>
    <?= $this->include('menuaccount/edit_accountmember'); ?>
<?= $this->endSection(); ?>