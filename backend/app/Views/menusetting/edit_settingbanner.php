 <!-- Modal Tambah Info -->
 <div class="modal fade" id="modalubahsettingbanner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <!-- Handle Form -->
        <?= form_open('setting/bannercontroller/perbaruidata',
           ['class' => 'formModalubahsettingbanner']); ?>
        <?= csrf_field(); ?>
        ...
        <div class="modal-body">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="TBNR001" 
                        name="settingbanner_kodeubah" id="settingbanner_kodeubah" readonly/>
                  <!-- Error Validation -->
                  <div class="invalid-feedback bg-secondary errorSettingbannerKodeubah">testte</div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="<?= base_url() . '/indeks/berita' ?>" 
                        name="settingbanner_linkubah" id="settingbanner_linkubah" />
                  <!-- Error Validation -->
                  <div class="invalid-feedback bg-secondary errorSettingbannerLinkubah">testte</div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" placeholder="Manager Investasi global" 
                        name="settingbanner_namaubah" id="settingbanner_namaubah" />
                  <!-- Error Validation -->
                  <div class="invalid-feedback bg-secondary errorSettingbannertNamaubah">testte</div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea id="settingbanner_deskripsiubah" name="settingbanner_deskripsiubah"></textarea>
                </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary btnmodalubahsettingbanner">Ubah</button>
        </div>
