...
<?= $this->section('content') ?>
          ...
          <div class="card">
            ...
            <div class="card-header">
              ...
              <p class="text-sm mb-0">
                Berisi pengaturan banner slider di Frontend
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahsettingbanner"
                      onClick="generatekodesettingbanner()">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-settingbanner">
    ...
    <?= $this->include('menusetting/add_settingbanner'); ?>
    <?= $this->include('menusetting/edit_settingbanner'); ?>
    <?= $this->include('menusetting/editimg_settingbanner'); ?>
<?= $this->endSection(); ?>