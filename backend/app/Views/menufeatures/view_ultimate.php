...
<?= $this->section('content') ?>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0">Data Ultimate Access</h3>
              <p class="text-sm mb-0">
                Berisi data yang hanya dapat diakses oleh akun dengan user ultimate
              </p>
              <button type="button" class="btn btn-primary btn-sm mt-3" 
                      data-toggle="modal" data-target="#modaltambahfeaturesultimate">
               <i class="fa fa-plus-circle"></i> Tambah Data
              </button>
            </div>
            <div class="table-responsive py-4">
              <table class="table table-flush" id="datatable-featuresultimate">
    ...
    <?= $this->include('menufeatures/add_ultimate'); ?> 
    <?= $this->include('menufeatures/edit_ultimate'); ?> 
<?= $this->endSection(); ?>