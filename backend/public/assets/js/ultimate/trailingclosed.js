...
$(document).ready( function () {
    var url = '/ultimate/Trailingclosedcontroller/ajax_list';
    var table = $('#datatable-ultimatetrailclosed').DataTable({ 
      "processing": true,
      "serverSide": true,
      "order": [],
      "ajax": {
...
function generatekodeultimatetrailclosed() {

    var url = "/ultimate/Trailingclosedcontroller/getdata";
    $.ajax({
        url: BASE_URL + url,
        dataType: "JSON",
...
$(document).ready(function() {
    $('.formModaltambahultimatetrailclosed').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function() {
                $('.btnmodaltambahultimatetrailingclosed').prop('disabled', true);
                $('.btnmodaltambahultimatetrailingclosed').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
                $('.btnmodaltambahultimatetrailingclosed').prop('disabled', false);
                $('.btnmodaltambahultimatetrailingclosed').html('Simpan');
            },
            success: function(response) {
                if (response.error){
                ...
                {
                    $('#modaltambahultimatetrailclosed').modal('hide');
                    ...
                    Swal.fire(
                        ...
                        $('#datatable-ultimatetrailclosed').DataTable().ajax.reload();
                    });
                }
            },
            error: function(xhr, ajaxOptions, thrownError) {
...
//Fungsi select data 
function editultimatetrailclosed($kode) {
    var url = "/ultimate/Trailingclosedcontroller/pilihdata";
    $.ajax({
        url: BASE_URL + url,
        type: "post",
        data: {
        ...
        success: function(response) {
            ...
            $('#modalubahultimatetrailclosed').modal('show');
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(xhr.status + "\n" + xhr.responseText + "\n" + thrownError);
        }
...
$(document).ready(function() {
    $('.formModalubahultimatetrailclosed').submit(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            dataType: "json",
            beforeSend: function() {
                $('.btnmodalubahultimatetrailingclosed').prop('disabled', true);
                $('.btnmodalubahultimatetrailingclosed').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
                $('.btnmodalubahultimatetrailingclosed').prop('disabled', false);
                $('.btnmodalubahultimatetrailingclosed').html('Ubah');
            },
            success: function(response) {
                if (response.error){
                ...
                {
					$('#modalubahultimatetrailclosed').modal('hide');
...
function deleteultimatetrailclosed($kode) {
    ...
    Swal.fire({
        ...
        if (result.value)
        {
            var url =  '/ultimate/Trailingclosedcontroller/hapusdata';
