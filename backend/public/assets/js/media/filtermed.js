    ...
    $('.formModaltambahmediafilter').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodaltambahmediafilter').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
...
function editmediafilter($kode) {
    ...
    $.ajax({
        ...
        success: function(response) {
			...
			$('#mediafilter_jenisubah').val(response.success.jenis);
    ...
    $('.formModalubahmediafilter').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodalubahmediafilter').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
