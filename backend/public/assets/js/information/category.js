    ...
    $('.formModaltambahcategorytype').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodaltambahcategorytype').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
...
function editinfocategory($kode) {
    ...
    $.ajax({
        ...
        success: function(response) {
			...
			$('#infocategory_jenispengumumanubah').val(response.success.kode_pengumuman);
    ...
    $('.formModalubahinfocategory').submit(function(e) {
        ...
        $.ajax({
            ...
            beforeSend: function() {
                ...
                $('.btnmodalubahinfocategory').html('<i class="fa fa-spin fa-spinner"></i> Processing');
            },
            complete: function() {
