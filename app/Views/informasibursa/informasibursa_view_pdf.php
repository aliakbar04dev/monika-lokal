                        ...
                        <div class="header">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <h6 style="font-size: 13px; color:#000;">
                                        ...
                                        <samp style="border-left: 2px #000 solid; margin-left: 10px;"></samp> &nbsp;&nbsp;
                                        <a style="font-weight: bold; color:#DD9B00;" href="<?= base_url('informasibursa') ?>">Informasi Bursa</a>
                                        <samp style="border-left: 2px #000 solid; margin-left: 10px;"></samp> &nbsp;&nbsp;
                            ...
                            <div class="row">
                                <?php foreach ($ipos as $ipo): ?>
                                    <div class="col-lg-6 pb-3 list-item" style="font-family: 'muli', sans-serif;">
                                        <div class="pb-3 pt-3 pl-5 pr-3" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 8px 12px 0 rgb(0 0 0 / 20%); border: 1px solid #dcdcdc;">
                                            ...
                                            <?php if ($ipo['isi_pengumuman'] == '' || $ipo['isi_pengumuman'] == ' ' || $ipo['isi_pengumuman'] == null): ?>
                                                <a href="<?= base_url().'/informasibursapdf/'.$ipo['kode_pengumuman'] ?>"><b style="color: #000; font-family: 'muli', sans-serif; font-size: 13px; margin-right:70%;">View</b></a>
                                            <?php elseif ($ipo['berkas'] == '' || $ipo['berkas'] == ' ' || $ipo['berkas'] == null): ?>
                                                <a href="<?= base_url().'/informasibursadetail/'.$ipo['kode_pengumuman'] ?>"><b style="color: #000; font-family: 'muli', sans-serif; font-size: 13px; margin-right:59%;">Read more</b></a>
                                            <?php else: ?>
                                                <a href="<?= base_url().'/informasibursadetail/'.$ipo['kode_pengumuman'] ?>"><b style="color: #000; font-family: 'muli', sans-serif; font-size: 13px;">Read more</b></a> &nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="<?= base_url().'/informasibursapdf/'.$ipo['kode_pengumuman'] ?>"><b style="color: #000; font-family: 'muli', sans-serif; font-size: 13px; margin-right:45%;">View</b></a>
                                            <?php endif; ?>
