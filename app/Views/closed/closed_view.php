        ...
        <div class="pt-1">
            <table>
                <tr class="head">
                    ...
                    <td><strong>
                            <div>Buy Price</div>
                            <div class="biru">Sell Price</div>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <div>Buy Date</div>
                            <div class="biru">Sell Date</div>
                        </strong>
                    </td>
                    <td>
                        <strong>
                            <div class="biru">Profit</div>
                            <div>Days Hold</div>
                        </strong>
                    </td>
                </tr>
               <!-- <tr>
                ...
                ?>
                    ...
                    <td>
                        ...
                        <div class="biru"><?= $item['sell_price']; ?></div>
                    </td>
                    <td>
                        <div><?= date('d/m/Y', strtotime($item['buy_date'])); ?></div>
                        <div class="biru"><?= date('d/m/Y', strtotime($item['sell_date'])); ?></div>
                    </td>
                    <td>
                        <div class="<?php 
