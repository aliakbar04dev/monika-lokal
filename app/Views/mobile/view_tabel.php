					...
					?>
						...
						<div class="card">
							<div class="card-body" style="background-color: #dbdbdb; border-radius:5px;">
								<form method="POST" id="mshowtable" class="needs-validation" novalidate="">
									<div class="row pb-3">
										<div class="col-lg-12">
											<div class="row">
											...
											<div class="container" style="border: 3px solid white; padding: 10px; border-top-left-radius: 25px; border-top-right-radius: 25px; border-bottom-left-radius: 25px; border-bottom-right-radius: 25px;">
												...
												<table class="table table-bordered" style="border:none; font-family:Poppins;">
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f bpjs</b> &nbsp;&nbsp; = Filter Beli Pagi Jual Suka Suka</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f bsjp</b> &nbsp;&nbsp; = Filter Beli Sore Jual Pagi</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f bulang</b> &nbsp;&nbsp; = Filter Bumi - Langit</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f bull</b> &nbsp;&nbsp; = Filter Uptrend</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f gps</b> &nbsp;&nbsp; = Filter GPS Kanan Atas</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f mcd</b> &nbsp;&nbsp; = Filter MACD Up</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f asin</b> &nbsp;&nbsp; = Filter Candle Awal Ikan Asin</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f warkop</b> &nbsp;&nbsp; = Filter Kreasi Keren Warkop PS</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f ps200</b> &nbsp;&nbsp; = Filter Filter mendekati Support 200</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f rg3</b> &nbsp;&nbsp; = Filter Potensi Tekbond</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f stoup</b> &nbsp;&nbsp; = Filter Stokastik Up</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f swb</b> &nbsp;&nbsp; = Filter Swing Buy dan Sell</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f ungu</b> &nbsp;&nbsp; = Filter saham ungu boom</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f hold</b> &nbsp;&nbsp; = Filter saham layak hold</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f ps20</b> &nbsp;&nbsp; = Filter potensi rebound di support 20</td>
													</tr>
												</table>
											</div>
										</div>
										<div class="col-md-12 mt-2">
											<div class="container" style="border: 3px solid white; padding: 10px; border-top-left-radius: 25px; border-top-right-radius: 25px; border-bottom-left-radius: 25px; border-bottom-right-radius: 25px;">
												...
												<table class="table table-bordered" style="border:none; font-family:Poppins;">
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f fan15</b> &nbsp;&nbsp; = Filter saham spike analizer TF 15 menit</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f swb15</b> &nbsp;&nbsp; = Filter saham fast trade TF 15 menit</td>
													</tr>
													<tr style="border:none;">
														<td style="border:none; text-align:left; height: 20px; color:black; font-size:12px;"><b style="color: #000;">/f tektok</b> &nbsp;&nbsp; = Filter saham tektok TF 5 menit</td>
													</tr>
												</table>
											</div>
											<br>
