<div class="container">
    <div class="col-lg-12">
        <center>
            ...
            <div class="col-lg-5 pt-5 pb-5 thk">
                <h5>Terimakasih</h5>
                ...
                <br><br>
                <div class="order pt-2 pb-2 pl-1 pr-1">
                    ORDER ID : <?= $bill['kode_pembayaran'] ?>
                </div>
            </div>
            <div class="col-lg-5 mt-3">
                <div class="ttl pt-1 pb-1 mb-3">
                ...
                <div> 
                    ...
                    <a class="float-left">Virtual Account BCA</a>
                    <a class="float-right">
                        <?php
                            if($bill['bank'] != ''){
