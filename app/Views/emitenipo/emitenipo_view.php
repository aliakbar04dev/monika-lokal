                    ...
                    <div class="mb-3" style="background-color: #eeeeee;">
                        <div class="header">
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <h6 style="font-size: 13px; color:#000;">
                                        ...
                                        <samp style="border-left: 2px #000 solid; margin-left: 10px;"></samp> &nbsp;&nbsp;
                                        <a href="<?= base_url('emitenipo') ?>" style="font-weight: bold; color:#DD9B00;">Emiten IPO, Raport Emiten, Special Report</a>
                                    </h6>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <?php if ($nm_kode == ' '): ?>
                                        <form action="emitenipo" method="get" id="searchFormEmitenipo">
                                            <div class="input-group" style="margin-top: -20px;">
                                                <input type="text" class="form-control" name="searchEmitenipo" id="searchEmitenipo" value="<?= $sEmIpo ?>"  style=" height: 35px; border-top-left-radius:5px; border-bottom-left-radius:5px; border-color:fff;">
                                                <div class="input-group-append">
                                                    <button class="btn btn-warning" type="button" onclick='document.getElementById("searchFormEmitenipo").submit();' style="background-color: #fdc134; border-color: #fdc134; color: #612D11;  height: 35px; border-top-right-radius:5px; border-bottom-right-radius:5px;">Cari</button>
                                                </div>
                                            </div>
                                        </form>
                                    <?php else: ?>
                                        <form action="" method="get" id="searchFormEmitenipo">
                                            <div class="input-group" style="margin-top: -20px;">
                                                <input type="text" class="form-control" name="searchEmitenipo" id="searchEmitenipo" value="<?= $sEmIpo ?>"  style=" height: 35px; border-top-left-radius:5px; border-bottom-left-radius:5px; border-color:fff;">
                                                <div class="input-group-append">
                                                    <button class="btn btn-warning" type="button" onclick='document.getElementById("searchFormEmitenipo").submit();' style="background-color: #fdc134; border-color: #fdc134; color: #612D11;  height: 35px; border-top-right-radius:5px; border-bottom-right-radius:5px;">Cari</button>
                            ...
                            <div class="mb-3">
                                ...
                                <form action="emitenipotags" method="post">
                                                ...
                                                <?php foreach ($kategoriIB as $kategoriIBrow): ?>
                                                    <th>
                                                        <?php if ($kategoriIBrow['nama_kategori_pengumuman'] == $nm_kode): ?>
                                                            <a href="<?= base_url('emitenipotags').'/'.$kategoriIBrow['nama_kategori_pengumuman'] ?>" id="tagsIpo" class="btn-tagsbursa btn btn-sm btn-secondary pl-4 pr-4" style="border-radius:50px; background-color:#fdc134; border-color:#fdc134; color:#000; ">
                                                                <?= $kategoriIBrow['nama_kategori_pengumuman'] ?>
                                                            </a>
                                                        <?php else: ?>
                                                            <a href="<?= base_url('emitenipotags').'/'.$kategoriIBrow['nama_kategori_pengumuman'] ?>" id="tagsIpo" class="btn-tagsbursa btn btn-sm btn-secondary pl-4 pr-4" style="border-radius:50px; background-color:#C4C4C4; border-color:#C4C4C4; color:#000; ">
                                                                <?= $kategoriIBrow['nama_kategori_pengumuman'] ?>
                                                            </a>
                                                        <?php endif; ?>
                                                    </th>
