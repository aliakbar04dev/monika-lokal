                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4 mt-3 mb-3" style="margin-left: -14px;">
                                <form action="stockreviewweeklypost" method="post">
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
                                                    <a href="<?= base_url().'/stockreviewweekly/'.$dataStart->code ?>" class="btn btn-sm btn-warning" style="border-radius: 5px; background-color:#FFD73A; border-color:#FFD73A; color:#000; font-family: Poppins; font-weight:bold;">Weekly</a>
                                                </td>
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
