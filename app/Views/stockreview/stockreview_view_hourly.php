                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4 mt-3 mb-3" style="margin-left: -14px;">
                                <form action="stockreviewhourlypost" method="post">
                                    ...
                                    <div class="table-responsive mt-3 mb-3" style="border-style: solid; border-radius: 5px; border-color:#707070; border-width: 1px;">
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
                                                    <a href="<?= base_url().'/stockreviewhourly/'.$dataStart->code ?>" class="btn btn-sm btn-warning" style="border-radius: 5px; background-color:#FFD73A; border-color:#FFD73A; color:#000; font-family: Poppins; font-weight:bold;">Hourly</a>
                                                </td>
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
