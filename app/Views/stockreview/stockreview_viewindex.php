                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-4 mt-3 mb-3" style="margin-left: -14px;">
                                <form action="stockreview" method="get" id="formStockreview">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="inputstockreview" id="inputstockreview" value="<?= $valStockReview ?>" placeholder="Kode Emiten" style="font-family: Poppins; font-weight:bold; font-size:12px; border-top-left-radius:5px; border-bottom-left-radius:5px;">
                                        <div class="input-group-append">
                                            <button class="btn btn-dark" type="button" onclick='document.getElementById("formStockreview").submit();' style="background-color: #710D0D; border-color: #710D0D; color: #fff; font-family: Poppins; font-weight:bold; border-top-right-radius:5px; border-bottom-right-radius:5px;">
                                                Cari
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="staticEmail" class="col-2 col-form-label mt-1" style="font-weight: bold; color:#000;">Kode Saham</label>
                                        <div class="col-8">
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-dark mt-2" type="button" onclick='document.getElementById("formStockreview").submit();' style="background-color: #710D0D; border-color: #710D0D; color: #fff; font-family: Poppins; font-weight:bold;">
                                                    Cari
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive mt-3 mb-3" style="border-style: solid; border-radius: 5px; border-color:#707070; border-width: 1px;">
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
                                                    <a href="<?= base_url().'/stockreviewdaily/'.$dataStart->code ?>" class="btn btn-sm btn-warning" style="border-radius: 5px; background-color:#FFD73A; border-color:#FFD73A; color:#000; font-family: Poppins; font-weight:bold;">Daily</a>
                                                </td>
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
                                                ...
                                                <td style="vertical-align: middle; color: #000; font-family: Poppins; font-weight:bold;">
                                                    <a href="<?= base_url().'/stockreviewfive/'.$dataStart->code ?>" class="btn btn-sm btn-warning" style="border-radius: 5px; background-color:#ffffff; border-color:#ffffff; color:#000; font-family: Poppins; font-weight:bold;">05min</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
