    ...
    ?>
        ...
        <div class="card">
            <div class="card-body" style="background-color: #dbdbdb; border-radius:5px;">
                <form method="POST" id="showtablefa" class="needs-validation" novalidate="">
                    <div class="row pb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 pt-2">
                                    <button type="submit" style="width:auto;" class="boxed-save" style="font-family:Poppins;">
                        ...
                        <div class="col-lg-2 text-center mt-2"></div>
