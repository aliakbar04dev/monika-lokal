    ...
    <div>
        <ul>
            ...
            <li class="white-content pb-4 pt-4 pl-4 -r-4">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-4">Anggota Komunitas PanenSaham</div>
                        <div class="col-8">
        ...
        <div class="modal-content">
            <div class="card-header pl-4 pr-4 pb-4">
                ...
                <div class="mt-5 text-muted text-center">
                    ...
                    Masukan email Komunitas Anda!
                </div>

                <div class="card-body">
                    <form method="POST" id="connectkomu_form" class="needs-validation" novalidate="">
                        <div class="form-group">
                            <input id="clientid" type="text" class="form-control" name="clientid" tabindex="1" placeholder="Contoh email : example@gmail.com" required autofocus>
                        </div>
