...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/public/assets/css/style-land.css?rand=123">
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/public/assets/css/warning.css">
...
<script type="text/javascript" charset="utf8" src="<?= base_url() ?>/public/assets/js/jquery.dataTables.min.js"></script>
<script type="text/javascript" charset="utf8" src="<?= base_url() ?>/public/assets/js/dataTables.bootstrap4.min.js"></script>
<script type="text/javascript" charset="utf8" src="<?= base_url() ?>/public/assets/js/dataTables.responsive.min.js"></script>
<script src="<?= base_url() ?>/public/assets/js/warning.js"></script>
...
<script> 
    ...
    const infoError = $(".flash-data-error").data('flashdataerror');
    if (infoError) {
        Swal.fire({
            title: 'Info ',
            text: infoError,
