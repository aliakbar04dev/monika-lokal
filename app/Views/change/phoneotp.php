            ...
            <div class="container mt-5">
                <div class="row">
                    <div class="login-card col-xl-4 offset-xl-4">
                        <form method="POST" id="formotpverif" class="needs-validation">
                            <div class="card">
                                <a class="mt-3 ml-4" style="text-align: left;" href="/changephone">BACK</a><br>
                                ...
                                <div class="card-body">
                                    <div>
                                        <div class="container body-content">
                                            ...
                                            <div style="text-align: center;"><a href="#" id="resendotp">Kirim Ulang</a> atau <a href="/changephone">Ubah No Handphone</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
