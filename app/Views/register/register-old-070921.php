...
<body style="background-color:#C1C1C1;">
    ...
    <div id="app">
        <section class="section">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 offset-xl-3" style="margin-top: 80px">
                        <div class="card">
                            <center>
                            ...
                            <div class="mt-4 text-muted text-center">
                                ...
                                <div class="disk pt-3">Daftarkan <strong>diskon up to 30%</strong> jika anda sudah
                                    bergabung<br>di komunitas dan koperasi PanenSaham</div>
                            </div>
                            <div class="card-body">
