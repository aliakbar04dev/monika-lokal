...
<body style="background-color:#C1C1C1;">
                    ...
                    <div class="login-card col-xl-6 offset-xl-3">
                        <div class="card" style="margin-top: -50px;">
                            <div class="mt-4 text-muted text-center">
                                <a href="<?= site_url('/'); ?>">
                                    <img alt="logo" src="<?= base_url(); ?>/public/assets/img/logomonika.png" width="50%" class="mt-2 mb-3" height="">
                                </a>
                                <h5 style="font-size: 25px;">Daftar Akun</h5>
                            ...
                            <div class="card-body">
                                <form method="POST" class="needs-validation" id="autoregistrationForm" style="margin-top: -30px;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input style="outline: none;" id="nama" type="text" class="form-control" name="nama" tabindex="1" required autofocus value="<?= $nameregis ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="hp">Username</label>
                                                            <input style="outline: none;" id="username" type="text" class="form-control" name="username" tabindex="1" required value="<?= $usernameregis ?>">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="col-lg-6">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <!-- <input style="outline: none;" id="email" type="email" class="form-control" name="email" tabindex="1" required autofocus readonly value="<?= $emailregis ?>"> -->
                                                        <!-- </div>
                                                    </div> -->
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <div class="d-block">
                                                                <label for="repeat" class="control-label">Ulangi Password</label>
                                                            </div>
                                                            <div class="input-group mb-3">
    ...
    <script src="<?= base_url() ?>/public/assets/js/function.js?rnd=133"></script>
