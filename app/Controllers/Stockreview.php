    ...
    public function index(){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                $queryMs = $this->dbmonikasecret->query("SELECT code, codename FROM `quotes`");
                $codeNames = $queryMs->getResult();
    ...
    public function daily($code){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$code' AND b.timeframe='Daily' AND c.timeframe='Daily' AND d.timeframe='Daily' AND e.timeframe='Daily'")->getRow();
    ...
    public function weekly($code){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$code' AND b.timeframe='Weekly' AND c.timeframe='Weekly' AND d.timeframe='Weekly' AND e.timeframe='Weekly'")->getRow();
    ...
    public function weeklypost(){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$valStockReview' AND b.timeframe='Weekly' AND c.timeframe='Weekly' AND d.timeframe='Weekly' AND e.timeframe='Weekly'")->getRow();
    ...
    public function hourly($code){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$code' AND b.timeframe='Hourly' AND c.timeframe='Hourly' AND d.timeframe='Hourly' AND e.timeframe='Hourly'")->getRow();
    ...
    public function hourlypost(){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$valStockReview' AND b.timeframe='Hourly' AND c.timeframe='Hourly' AND d.timeframe='Hourly' AND e.timeframe='Hourly'")->getRow();
    ...
    public function fivemin($code){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$code' AND b.timeframe='5-minute' AND c.timeframe='5-minute' AND d.timeframe='5-minute' AND e.timeframe='5-minute'")->getRow();
    ...
    public function fiveminpost(){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$valStockReview' AND b.timeframe='5-minute' AND c.timeframe='5-minute' AND d.timeframe='5-minute' AND e.timeframe='5-minute'")->getRow();
    ...
    public function fifteenmin($code){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$code' AND b.timeframe='15-minute' AND c.timeframe='15-minute' AND d.timeframe='15-minute' AND e.timeframe='15-minute'")->getRow();
    ...
    public function fifteenminpost(){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$valStockReview' AND b.timeframe='15-minute' AND c.timeframe='15-minute' AND d.timeframe='15-minute' AND e.timeframe='15-minute'")->getRow();
                // echo json_encode($valStockReview); die; 
    ...
    public function thirtymin($code){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$code' AND b.timeframe='30-minute' AND c.timeframe='30-minute' AND d.timeframe='30-minute' AND e.timeframe='30-minute'")->getRow();
    ...
    public function thirtyminpost(){
        if (!hassession('email')) {
			...
			if($this->usr->checksessionuser(getsession('email'), getsession('sesskode'))){
                ...
                LEFT JOIN foreign_nbs d ON d.code=a.code 
                LEFT JOIN effective_value e ON e.code=a.code 
                WHERE a.code='$valStockReview' AND b.timeframe='30-minute' AND c.timeframe='30-minute' AND d.timeframe='30-minute' AND e.timeframe='30-minute'")->getRow();
                // echo json_encode($dataStart); die; 
