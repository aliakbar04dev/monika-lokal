	...
	public function newRegistration()
	{
		if ($this->request->isAJAX()) {
			...
			if ($dataUser > 0) {
				...
				do {
					$prefix 	= 'TUSR';
					$get		= $this->regisTmpModel->select('kode_user, CAST(SUBSTR(kode_user FROM 5) AS SIGNED) as kode')->orderBy('kode', "desc")->first();
					...
					$this->regisTmpModel->insert($data);
					$insert = $this->regisTmpModel->affectedRows();
